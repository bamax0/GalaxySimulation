...
public:
    ...
    GLWinApp(int width, int height, std::string& window_name, cv::VideoCapture& m_cap) :
...
int main(int argc, char** argv)
{
    ...
    int width  = (int)m_cap.get(CAP_PROP_FRAME_WIDTH);
    int height = (int)m_cap.get(CAP_PROP_FRAME_HEIGHT);
    ...
    GLWinApp app(width, height, wndname, m_cap);
