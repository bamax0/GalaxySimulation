...
#define DECLARE_DYNAMIC_BACKEND(m_cap, name, mode) \
{ \
    m_cap, (BackendMode)(mode), 1000, name, createPluginBackendFactory(m_cap, name) \
},
#else
#define DECLARE_DYNAMIC_BACKEND(m_cap, name, mode)  /* nothing */
#endif

#define DECLARE_STATIC_BACKEND(m_cap, name, mode, createCaptureFile, createCaptureCamera, createWriter) \
{ \
    m_cap, (BackendMode)(mode), 1000, name, createBackendFactory(createCaptureFile, createCaptureCamera, 0, createWriter) \
},

#define DECLARE_STATIC_BACKEND_WITH_STREAM_SUPPORT(m_cap, name, mode, createCaptureStream) \
{ \
    m_cap, (BackendMode)(mode), 1000, name, createBackendFactory(0, 0, createCaptureStream, 0) \
},
